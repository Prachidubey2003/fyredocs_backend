...
// authContextFromGatewayHeaders and extractBearerToken are shared with the
// HTTP middleware (middleware_http.go). The gateway-header parser also fills
// plan fields; services that don't read them are unaffected.
